declare module "@swarmfarm/jsts" {
  export namespace algorithm {
    import CoordinateSequence = geom.CoordinateSequence;
    import Coordinate = geom.Coordinate;
    import Geometry = geom.Geometry;
    import GeometryFactory = geom.GeometryFactory;
    import PrecisionModel = geom.PrecisionModel;
    ...
    export class Orientation {
      ...
      static index(p1: Coordinate, p2: Coordinate, q: Coordinate): number;
    ...
    export class Angle {
       ...
       */
      static angle(p: Coordinate): number;

      /**
       * Returns the angle of the vector from p0 to p1, relative to the positive X-axis.
       */
      static angle(p0: Coordinate, p1: Coordinate): number;
       ...
       */
      static diff(ang1: number, ang2: number): number;

      /**
       * Returns whether an angle must turn clockwise or counterclockwise to overlap another angle.
       */
      static getTurn(ang1: number, ang2: number): number;
       ...
       */
      static isAcute(p0: Coordinate, p1: Coordinate, p2: Coordinate): boolean;

      /**
       * Tests whether the angle between p0-p1-p2 is obtuse.
       */
      static isObtuse(p0: Coordinate, p1: Coordinate, p2: Coordinate): boolean;
       ...
       */
      static normalizePositive(angle: number): number;

      /**
       * Projects a point by a given angle and distance.
       */
      static project(p: Coordinate, angle: number, dist: number): Coordinate;
    ...
    export class PointLocation {
       ...
       * @returns true if the point is a vertex of the line or lies in the interior of a line segment in the line
       */
      static isOnLine(p: Coordinate, line: Coordinate[]): boolean;
       ...
       * @returns true if the point is a vertex of the line or lies in the interior of a line segment in the line
       */
      static isOnLine(p: Coordinate, line: CoordinateSequence): boolean;

      /**
       * Tests whether a point lies inside or on a ring. The ring may be oriented in either direction.
       ...
       */
      static isInRing(p: Coordinate, ring: Coordinate[]): boolean;
       ...
       */
      static locateInRing(p: Coordinate, ring: Coordinate[]): number;
    }
  ...
  export namespace geom {
    ...
    export class Envelope {
       ...
       *
       * @param {geom.Coordinate} p1 the first Coordinate.
       * @param {geom.Coordinate} p2 the second Coordinate.
       */
       ...
       * Coordinate.
       *
       * @param {geom.Coordinate} p the Coordinate.
       */
       ...
       *
       * @param {geom.Envelope} env the Envelope to initialize from.
       */
       ...
       * envelope.
       *
       * @param {geom.Coordinate} p the Coordinate to expand to include.
       */
       ...
       *
       * @param {geom.Envelope} other the <code>Envelope</code> to expand to include.
       */
       ...
       * non-null
       *
       * @return {geom.Coordinate} the centre coordinate of this envelope <code>null</code>
       ...
       * @return {geom.Envelope} a new Envelope representing the intersection of
      ...
      /**
       * @return {geom.Envelope} A new instance copied from this.
       */
      clone(): Envelope;
    }
    ...
    export class Geometry {
      ...
      static readonly TYPECODE_POINT: 0;
      static readonly TYPECODE_MULTIPOINT: 1;
      static readonly TYPECODE_LINESTRING: 2;
      static readonly TYPECODE_LINEARRING: 3;
      static readonly TYPECODE_MULTILINESTRING: 4;
      static readonly TYPECODE_POLYGON: 5;
      static readonly TYPECODE_MULTIPOLYGON: 6;
      static readonly TYPECODE_GEOMETRYCOLLECTION: 7;
      static readonly TYPENAME_POINT: "Point";
      static readonly TYPENAME_MULTIPOINT: "MultiPoint";
      static readonly TYPENAME_LINESTRING: "LineString";
      static readonly TYPENAME_LINEARRING: "LinearRing";
      static readonly TYPENAME_MULTILINESTRING: "MultiLineString";
      static readonly TYPENAME_POLYGON: "Polygon";
      static readonly TYPENAME_MULTIPOLYGON: "MultiPolygon";
      static readonly TYPENAME_GEOMETRYCOLLECTION: "GeometryCollection";
      /**
       ...
       *
       * @return {geom.GeometryFactory} the factory for this geometry.
       */
      getFactory(): any;
    ...
    export class LineString extends Geometry {
      ...
      /**
       * Computes a new LineString geometry which has all component coordinate sequences in reverse order (opposite orientation) to this one.
       * @return {LineString} The reversed LineString geometry.
       */
      reverse(): LineString;
      /**
       * @return {geom.Coordinate} The n'th coordinate of this
       *         geom.LineString.
       * @param {int}
       *          n index.
       */
      ...
      /**
       * @return {geom.Point} The n'th point of this
       *         geom.LineString.
       * @param {int}
       *          n index.
       */
      ...
      /**
       * @return {geom.Point} The first point of this
       *         geom.LineString.
       */
      getStartPoint(): Point;

      /**
       * @return {geom.Point} The last point of this
       *         geom.LineString.
       */
      getEndPoint(): Point;
      ...
      init(points: Array<Coordinate>): void;
    }
    ...
    export class MultiPoint extends GeometryCollection {
      constructor(lineStrings: Point[], factory: GeometryFactory);
      /**
       * @deprecated Use GeometryFactory instead
       */
      constructor(
    ...
    namespace util {
      ...
      export class LineStringExtracter {
        private _comps: any;

        constructor(...comps: any[]);

        static getGeometry(geom: Geometry): Geometry;

        static getLines(
          geom: Geometry,
          lines?: java.utils.List<LineString>
        ): java.utils.List<LineString>;
    ...
    export class LineSegment {
       ...
       *
       * @param {geom.Coordinate} p0
       * @param {geom.Coordinate} p1
       * @return {geom.Coordinate} the midpoint of the segment
       */
       ...
       * </ul>
       *
       * @param {geom.LineSegment} seg the LineSegment to compare
       *
       ...
       *
       * @param {geom.Coordinate} p the coordinate to compare
       *
       ...
       *
       * @param {geom.LineSegment | geom.Coordinate}
       ...
       * @return {geom.Coordinate} the point at that distance
       */
       ...
       * @return {geom.Coordinate} the point at that distance and offset
       */
      pointAlongOffset(
       ...
       *
       * @param {geom.Coordinate} inputPt the point
       ...
       *
       * @param {geom.LineSegment} seg the line segment to project
       * @return {geom.LineSegment} the projected line segment, or <code>null</code> if there is no overlap
       */
       ...
       *
       * @param {geom.LineSegment} line a line segment defining an straight line with infinite extent
       * @return {geom.Coordinate} an intersection point,
       ...
       *
       * @param {geom.GeometryFactory} geomFactory the geometery factory to use
       * @return {geom.LineString} a LineString with the same geometry as this segment
       */
       ...
       *  of orientation).
       *
       * @param {geom.LineSegment} other  a <code>LineSegment</code> with which to do the comparison.
       * @return {boolean} <code>true</code> if <code>other</code> is a <code>LineSegment</code>
       *      with the same values for the x and y ordinates.
       */
  ...
  export namespace io {
    ...
    export class OL3Parser {
      constructor(geometryFactory?: geom.GeometryFactory);
      read(geometry: any /* ol.geom.Geometry */): geom.Geometry;
      write(geometry: geom.Geometry): any /* ol.geom.Geometry */;
    }
    ...
    export class GeoJSONReader {
       ...
       */
      read(geometry: any): geom.Geometry;
    }
    export class GeoJSONWriter {
       ...
       */
      write(geometry: geom.Geometry): any;
    }
    ...
    export class WKTReader {
       ...
       *          Specification).
       * @return {geom.Geometry} a <code>Geometry</code> read from
       *         <code>string.</code>
       */
  ...
  export namespace operation {
    import Geometry = geom.Geometry;
    import Coordinate = geom.Coordinate;
    import LineString = geom.LineString;
    import Polygon = geom.Polygon;
    import OffsetCurveSection = buffer.OffsetCurveSection;
    import SegmentMCIndex = buffer.SegmentMCIndex;
    import PrecisionModel = geom.PrecisionModel;
    import BoundaryNodeRule = algorithm.BoundaryNodeRule;
    import BufferParameters = buffer.BufferParameters;
    import STRtree = tree.STRtree;
    ...
    /**
     * Builder for creating offset curves of line and point geometries.
     */
    export class OffsetCurveBuilder {
      ...
      /**
       * Generates the line curve for the given input points and distance.
       * This method handles single points as well as LineStrings.
       * @param inputPts - The input points.
       * @param distance - The offset distance.
       * @returns The line curve coordinates.
       */
      getLineCurve(inputPts: Coordinate[], distance: number): Coordinate[];

      /**
       * Generates the offset curve for the given input points and distance.
       * @param inputPts - The input points.
       * @param distance - The offset distance.
       * @returns The offset curve coordinates.
       */
      getOffsetCurve(inputPts: Coordinate[], distance: number): Coordinate[];

      /**
       * Generates the ring curve for the given input points, side, and distance.
       * This method handles the degenerate cases of single points and lines, as well as valid rings.
       * @param inputPts - The input points.
       * @param side - The side of the ring (1 or -1).
       * @param distance - The offset distance.
       * @returns The ring curve coordinates.
       */
      getRingCurve(
        inputPts: Coordinate[],
        side: number,
       ...
       * @param distance - The offset distance.
       * @returns True if the offset curve is empty, false otherwise.
       */
      isLineOffsetEmpty(distance: number): boolean;
    }

    export class OffsetCurve {
      static MATCH_DISTANCE_FACTOR: number;
      static MIN_QUADRANT_SEGMENTS: number;
      static NOT_IN_CURVE: number;
      ...
      static getCurve(geom: Geometry, distance: number): Geometry;
      static getCurveWithParams(
        geom: Geometry,
        distance: number,
        quadSegs: number,
        joinStyle: number,
      ...
      static getCurveJoined(geom: Geometry, distance: number): Geometry;
      ...
      private computeCurve(lineGeom: LineString, distance: number): Geometry;
      private computeSections(
        lineGeom: LineString,
        distance: number
      ): OffsetCurveSection[];
      private offsetSegment(pts: Coordinate[], distance: number): LineString;
      private computeCurveSections(
        bufferRingPts: Coordinate[],
        rawCurve: Coordinate[],
        sections: OffsetCurveSection[]
      ): void;

      private matchSegments(
        raw0: Coordinate,
        raw1: Coordinate,
        rawCurveIndex: number,
        bufferSegIndex: SegmentMCIndex,
        bufferPts: Coordinate[],
        rawCurvePos: number[]
      ): number;
      ...
      private findSectionStart(loc: number[], end: number): number;
      ...
      private next(i: number, size: number): number;
      private prev(i: number, size: number): number;

      static getBufferOriented(
        geom: LineString,
        distance: number,
        bufParams: BufferParameters
      ): Polygon;
      static extractMaxAreaPolygon(geom: Geometry): Polygon;
    }

    namespace relate {
      import Geometry = geom.Geometry;
      import IntersectionMatrix = geom.IntersectionMatrix;
    ...
    namespace buffer {
      ...
      export class BufferOp {
        ...
        static bufferOp(
          g: Geometry,
          distance: number,
          paramsOrquadrantSegments: BufferParameters | number,
          endCapStyle?: number
        ): Geometry;
      ...
      export class OffsetCurveSection {
        sectionPts: Array<Coordinate>;
        location: number;
        locLast: number;

        constructor(pts: Array<Coordinate>, loc: number, locLast: number);

        static toGeometry(
          sections: Array<OffsetCurveSection>,
          geomFactory: any
        ): any;
        static toLine(
          sections: Array<OffsetCurveSection>,
        ...
        isEndInSameSegment(nextLoc: number): boolean;
        compareTo(section: OffsetCurveSection): number;
      }

      export class SegmentMCIndex {
        private _index: STRtree<any>;
        private _idCounter: number;

        constructor(segs: Array<Coordinate>);

        private buildIndex(segs: Array<Coordinate>): void;

        query(env: any, action: any): void;
      }
    }
    ...
    namespace valid {
      ...
      import Geometry = geom.Geometry;
      class IsValidOp {
        private _parentGeometry: Geometry | null;
        private _isSelfTouchingRingFormingHoleValid: boolean;
        private _validErr: TopologyValidationError | null;

        constructor(parentGeometry: Geometry);

        static isValid(geom: Geometry): boolean;
        static isValid(coord: Coordinate): boolean;
        static isValid(arg: Geometry | Coordinate): boolean;

        isValid(): boolean;
        getValidationError(): TopologyValidationError | null;
      }
      class TopologyValidationError {
        private _errorType: number;
        private _pt: Coordinate | null;

        constructor(errorType: number, pt?: Coordinate | null);
        ...
        static readonly REPEATED_POINT: number;
        static readonly HOLE_OUTSIDE_SHELL: number;
        static readonly NESTED_HOLES: number;
        static readonly DISCONNECTED_INTERIOR: number;
        static readonly SELF_INTERSECTION: number;
        static readonly RING_SELF_INTERSECTION: number;
        static readonly NESTED_SHELLS: number;
        static readonly DUPLICATE_RINGS: number;
        static readonly TOO_FEW_POINTS: number;
        static readonly INVALID_COORDINATE: number;
        static readonly RING_NOT_CLOSED: number;
        static readonly errMsg: string[];
      }
    }
  }
  ...
  export namespace tree {
     ...
     * The index is semi-static; items may not be added once the tree has been built.
     * Items may be removed from the tree using `remove(Envelope, Object)`.
     *
     * @see {@link https://link.springer.com/chapter/10.1007/3-540-62822-8_9}
     * @see {@link https://en.wikipedia.org/wiki/R-tree}
     */
    export class STRtree<T> {
      /**
       ...
       *
       * @param {number} nodeCapacity - The maximum number of child nodes that a node may have.
       */
      constructor(nodeCapacity: number);

      /**
       * Constructs an STRtree with the given maximum number of child nodes that a node may have
       * and all leaf nodes in the tree.
       *
       * @param {number} nodeCapacity - The maximum number of child nodes that a node may have.
       * @param {Array} itemBoundables - The leaf nodes in the tree.
       */
      constructor(nodeCapacity: number, itemBoundables: Array<any>);

      /**
       * Constructs an STRtree with the given maximum number of child nodes that a node may have
       * and the root that links to all other nodes.
       *
       * @param {number} nodeCapacity - The maximum number of child nodes that a node may have.
       * @param {STRtreeNode} root - The root that links to all other nodes.
       */
      constructor(nodeCapacity: number, root: STRtreeNode);
       ...
       *
       * @param {Envelope} itemEnv - The bounds of the item to insert.
       * @param {Object} item - The item to insert.
       */
      insert(itemEnv: Envelope, item: T): void;

      /**
       * Tests whether some two items from this tree and another tree lie within a given distance.
       *
       * @param {STRtree} tree - The other tree to test against.
       * @param {ItemDistance} itemDist - The distance metric.
       * @param {number} maxDistance - The maximum distance.
       * @return {boolean} A flag indicating if items within the given distance exist.
       */
      isWithinDistance(
        tree: STRtree<any>,
        itemDist: ItemDistance,
        maxDistance: number
      ): boolean;
       ...
       *
       * @param {Envelope} env - The envelope to search within.
       * @param {Object} item - The item for which to find the nearest neighbor.
       * @param {ItemDistance} itemDist - The distance metric.
       * @return {Object} The item nearest to the given item.
       */
      nearestNeighbour(env: Envelope, item: T, itemDist: ItemDistance): T;
       ...
       *
       * @param {Envelope} env - The envelope to search within.
       * @param {Object} item - The item for which to find the nearest neighbors.
       * @param {ItemDistance} itemDist - The distance metric.
       * @param {number} k - The maximum number of nearest neighbors to find.
       * @return {Object[]} An array of up to k items nearest to the given item.
       */
      nearestNeighbour(
        env: Envelope,
        item: any,
       ...
       *
       * @param {ItemDistance} itemDist - The distance metric.
       * @return {Object[]} An array containing the two nearest items in the tree.
       */
      nearestNeighbour(itemDist: ItemDistance): List<T>;

      /**
       * Finds the two nearest items from this tree and another tree, using ItemDistance as the distance metric.
       *
       * @param {strtree} tree - The other tree to find nearest items from.
       * @param {ItemDistance} itemDist - The distance metric.
       * @return {Object[]} An array containing the two nearest items from both trees.
       */
      nearestNeighbour(tree: STRtree<any>, itemDist: ItemDistance): List<T>;

      /**
       * Returns items whose bounds intersect the given envelope.
       *
       * @param {Envelope} searchEnv - The envelope to query.
       * @return {List} A list of items whose bounds intersect the given envelope.
       */
      query(searchEnv: Envelope): List<T>;

      /**
       * Returns items whose bounds intersect the given envelope.
       *
       * @param {Envelope} searchEnv - The envelope to query.
       * @param {ItemVisitor} visitor - The visitor to process the matching items.
       */
      query(searchEnv: Envelope, visitor: ItemVisitor): void;

      /**
       * Removes a single item from the tree.
       *
       * @param {Envelope} itemEnv - The bounds of the item to remove.
       * @param {Object} item - The item to remove.
       * @return {boolean} A flag indicating if the item was successfully removed.
       */
      remove(itemEnv: Envelope, item: T): boolean;
    ...
    /**
     * The STRtreeNode represents a node in the STRtree index.
     */
    export class STRtreeNode {
      // Additional implementation for STRtreeNode can be added here if needed.
    }

    export class ItemBoundable {}
    /**
     * The ItemDistance interface defines a contract for computing the distance between two items in a spatial index.
     */
    export interface ItemDistance {
       ...
       */
      distance(item1: ItemBoundable, item2: ItemBoundable): number;
    }

    /**
     * The ItemVisitor interface defines a contract for visiting items in a spatial index.
     */
     ...
     * Geometrys can be indexed by using their Envelopes. Any type of Object can also be indexed as long as it has an extent that can be represented by an Envelope.
     *
     * @remarks
     * This Quadtree index provides a primary filter for range rectangle queries. The various query methods return a list of all items which may intersect the query rectangle.
     * Note that it may thus return items which do not in fact intersect the query rectangle.
     * A secondary filter is required to test for actual intersection between the query rectangle and the envelope of each candidate item.
     * The secondary filter may be performed explicitly, or it may be provided implicitly by subsequent operations executed on the items.
     *
     * @remarks
     * This implementation does not require specifying the extent of the inserted items beforehand.
    ...
    export class Quadtree<T> {
       ...
       * @param minExtent - The minimum extent value.
       * @returns The adjusted envelope.
       * @static
       */
      static ensureExtent(itemEnv: Envelope, minExtent: number): Envelope;

      /**
       * Adds a spatial item with an extent specified by the given Envelope to the index.
       *
       * @param itemEnv - The envelope of the item to be inserted.
       ...
       *
       * @returns A boolean value indicating if the index is empty.
       */
      isEmpty(): boolean;
       ...
       * @returns A list of items that may intersect the search envelope.
       */
      query(searchEnv: Envelope): List<T>;
       ...
       *
       * @param searchEnv - The search envelope.
       * @param visitor - The item visitor to be invoked for each item.
       */
      query(searchEnv: Envelope, visitor: ItemVisitor): void;
       ...
       * @returns A boolean value indicating if the removal was successful.
       */
      remove(itemEnv: Envelope, item: T): boolean;
    }
  }
  export namespace linearref {
    import LineString = geom.LineString;
    import Coordinate = geom.Coordinate;
    import Geometry = geom.Geometry;
    export class ExtractLineByLocation {
      constructor();
      static extract();
    }
    /**
     ...
     * Non-simple lines (i.e. which loop back to cross or touch themselves) are supported.
     */
    export class LengthIndexedLine {
       ...
       */
      public extractPoint(index: number): Coordinate;
       ...
       * The Z-ordinate of the computed point will be interpolated from the Z-ordinates of the line segment containing it, if they exist.
       * @param index - The index of the desired point.
       * @param offsetDistance - The distance the point is offset from the segment (positive is to the left, negative is to the right).
       * @returns The Coordinate at the given index.
       */
      public extractPoint(index: number, offsetDistance: number): Coordinate;
       ...
       */
      public extractLine(startIndex: number, endIndex: number): LineString;

      /**
       * Computes the minimum index for a point on the line.
       * If the line is not simple (i.e. loops back on itself), a single point may have more than one possible index.
       * In this case, the smallest index is returned.
       * The supplied point does not necessarily have to lie precisely on the line, but if it is far from the line,
       * the accuracy and performance of this function is not guaranteed.
       * Use `project` to compute a guaranteed result for points which may be far from the line.
       * @param pt - A point on the line.
       * @returns The minimum index of the point.
       * @see project
       */
      public indexOf(pt: Coordinate): number;

      /**
       * Finds the index for a point on the line which is greater than the given index.
       * If no such index exists, returns minIndex.
       * This method can be used to determine all indexes for a point which occurs more than once on a non-simple line.
       * It can also be used to disambiguate cases where the given point lies slightly off the line and is equidistant from two different points on the line.
       * The supplied point does not necessarily have to lie precisely on the line, but ifit is far from the line, the accuracy and performance of this function is not guaranteed.
       * Use `project` to compute a guaranteed result for points which may be far from the line.
       * @param pt - A point on the line.
       * @param minIndex - The value the returned index must be greater than.
       * @returns The index of the point greater than the given minimum index.
       * @see project
       */
      public indexOfAfter(pt: Coordinate, minIndex: number): number;
       ...
       */
      public indicesOf(subLine: Geometry): number[];
       ...
       */
      public project(pt: Coordinate): number;
       ...
       * @returns True if the index is in the valid range.
       */
